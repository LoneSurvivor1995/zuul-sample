...
public class Constants {
	...
	public static final String ZUUL_FILTER_PRE_PATH = "com.lone.filter.pre";
	public static final String ZUUL_FILTER_ROUTE_PATH = "com.lone.filter.route";
	public static final String ZUUL_FILTER_POST_PATH = "com.lone.filter.post";
	public static final String ZUUL_FILTER_ERROR_PATH = "com.lone.filter.error";
	public static final String Zuul_FILTER_CUSTOM_PATH = "com.lone.filter.custom";
